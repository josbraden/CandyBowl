...
public class CandyBowl {
	...
	public static void main(String[]args) {
		...
		switch (menuoption) {
			case 1: DefaultParams();
				break;
			case 2: EnumParams();
				break;
			default: System.out.println("Bad option entered, using default parameters");
				DefaultParams();
				break;
		}
	}
	...
	private static void DefaultParams() {
		//Set up default data
		String[] Names = {"Dr. Cooper", "Dr. Burris", "Dr. Smith", "Dr. McGuire", "Dr. Cho"};
		int SleepTime;
				...
				try {
					...
					for (int i = 0; i < ProfKnt; i++) {
						Professors[i].interrupt();
                                ...
                                break;
                        default: System.out.println("Bad option entered, running forever");
				for (int i = 0; i < ProfKnt; i++) {
                                        Professors[i].start();
                                }
                                break;
